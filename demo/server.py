...
_ALL_MODELS = [
    "/data/models/Qwen3-TTS-12Hz-0.6B-Base",
    "/data/models/Qwen3-TTS-12Hz-1.7B-Base",
    "/data/models/Qwen3-TTS-12Hz-0.6B-CustomVoice",
    "/data/models/Qwen3-TTS-12Hz-1.7B-CustomVoice",
    "/data/models/Qwen3-TTS-12Hz-1.7B-VoiceDesign",
]
...
_ASSET_DIR = Path(os.environ.get("ASSET_DIR", "/data/tts/faster-qwen3-tts-assets"))
...
PRESET_REFS = [
    ...
    ("ref_audio_4", _ASSET_DIR / "ref_audio_4.mp3", "Clone 4"),
    ("ref_audio_5", _ASSET_DIR / "ref_audio_5.mp3", "Clone 5"),
    ("ref_audio_6", _ASSET_DIR / "ref_audio_6.wav", "Clone 6"),
    ("ref_audio_7", _ASSET_DIR / "ref_audio_7.wav", "Clone 7"),
    ("ref_audio_8", _ASSET_DIR / "ref_audio_8.wav", "Clone 8"),
    ("ref_audio_101", _ASSET_DIR / "ref_audio_101.mp3", "Clone101"),
    ("ref_audio_102", _ASSET_DIR / "ref_audio_102.mp3", "Clone102"),
    ("ref_audio_103", _ASSET_DIR / "ref_audio_103.mp3", "Clone103"),
    ("ref_audio_104", _ASSET_DIR / "ref_audio_104.mp3", "Clone104"),
    ("ref_audio_105", _ASSET_DIR / "ref_audio_105.mp3", "Clone105"),
    ("ref_audio_106", _ASSET_DIR / "ref_audio_106.mp3", "Clone106"),
    ("ref_audio_107", _ASSET_DIR / "ref_audio_107.mp3", "Clone107"),
    ("ref_audio_108", _ASSET_DIR / "ref_audio_108.mp3", "Clone108"),
    ("ref_audio_109", _ASSET_DIR / "ref_audio_109.mp3", "Clone109"),
    ("ref_audio_110", _ASSET_DIR / "ref_audio_110.mp3", "Clone110"),
    ("ref_audio_111", _ASSET_DIR / "ref_audio_111.mp3", "Clone111"),
    ("ref_audio_112", _ASSET_DIR / "ref_audio_112.mp3", "Clone112"),
    ("ref_audio_113", _ASSET_DIR / "ref_audio_113.mp3", "Clone113"),
    ("ref_audio_114", _ASSET_DIR / "ref_audio_114.mp3", "Clone114"),
    ("ref_audio_115", _ASSET_DIR / "ref_audio_115.mp3", "Clone115"),
    ("ref_audio_116", _ASSET_DIR / "ref_audio_116.mp3", "Clone116"),
    ("ref_audio_117", _ASSET_DIR / "ref_audio_117.mp3", "Clone117"),
    ("ref_audio_118", _ASSET_DIR / "ref_audio_118.mp3", "Clone118"),
    ("ref_audio_119", _ASSET_DIR / "ref_audio_119.mp3", "Clone119"),
    ("ref_audio_120", _ASSET_DIR / "ref_audio_120.mp3", "Clone120"),
    ("ref_audio_121", _ASSET_DIR / "ref_audio_121.mp3", "Clone121"),
    ("ref_audio_122", _ASSET_DIR / "ref_audio_122.mp3", "Clone122"),
    ("ref_audio_123", _ASSET_DIR / "ref_audio_123.mp3", "Clone123"),
    ("ref_audio_124", _ASSET_DIR / "ref_audio_124.mp3", "Clone124"),
    ("ref_audio_125", _ASSET_DIR / "ref_audio_125.mp3", "Clone125"),
    ("ref_audio_126", _ASSET_DIR / "ref_audio_126.mp3", "Clone126"),
    ("ref_audio_127", _ASSET_DIR / "ref_audio_127.mp3", "Clone127"),
    ("ref_audio_128", _ASSET_DIR / "ref_audio_128.mp3", "Clone128"),
    ("ref_audio_129", _ASSET_DIR / "ref_audio_129.mp3", "Clone129"),
    ("ref_audio_130", _ASSET_DIR / "ref_audio_130.mp3", "Clone130"),
    ("ref_audio_131", _ASSET_DIR / "ref_audio_131.mp3", "Clone131"),
    ("ref_audio_132", _ASSET_DIR / "ref_audio_132.mp3", "Clone132"),
    ("ref_audio_133", _ASSET_DIR / "ref_audio_133.mp3", "Clone133"),
    ("ref_audio_134", _ASSET_DIR / "ref_audio_134.mp3", "Clone134"),
    ("ref_audio_135", _ASSET_DIR / "ref_audio_135.mp3", "Clone135"),
    ("ref_audio_136", _ASSET_DIR / "ref_audio_136.mp3", "Clone136"),
    ("ref_audio_137", _ASSET_DIR / "ref_audio_137.mp3", "Clone137"),
    ("ref_audio_138", _ASSET_DIR / "ref_audio_138.mp3", "Clone138"),
    ("ref_audio_139", _ASSET_DIR / "ref_audio_139.mp3", "Clone139"),
    ("ref_audio_140", _ASSET_DIR / "ref_audio_140.mp3", "Clone140"),
    ("ref_audio_141", _ASSET_DIR / "ref_audio_141.mp3", "Clone141"),
    ("ref_audio_142", _ASSET_DIR / "ref_audio_142.mp3", "Clone142"),
    ("ref_audio_143", _ASSET_DIR / "ref_audio_143.mp3", "Clone143"),
    ("ref_audio_144", _ASSET_DIR / "ref_audio_144.mp3", "Clone144"),
    ("ref_audio_145", _ASSET_DIR / "ref_audio_145.mp3", "Clone145"),
]
...
def _fetch_preset_assets() -> None:
    ...
    if not PRESET_TRANSCRIPTS.exists(): # 如果预设的transcripts不存在，则从GitHub下载。并保存到本地如下位置： PRESET_TRANSCRIPTS
        try:
    ...
    for key, path, _ in PRESET_REFS:
        if not path.exists() and key in _PRESET_REMOTE: # 如果预设的ref不存在、但下载地址可以在_PRESET_REMOTE中找到，则从GitHub下载。
            try:
...
def _prime_preset_voice_cache(model: FasterQwen3TTS) -> None:
    ...
    for preset in _preset_refs.values():
        ...
        # 对每个预置条目（ref_audio_3、ref_audio 等），各跑一遍 Simple（xvec_only=True） 和 Advanced（xvec_only=False） 的 _prepare_generation。
        for xvec_only in (True, False):
            try:
                # 用固定短句 "Hello." 当占位文本，目的是触发模型内部与参考音频 / 说话人相关的准备步骤（例如编码参考音频、建缓存等），而不是为了生成完整语音给用户听。
                ...
                # 某条预置或某种模式失败就 continue，不影响其它条目。
                continue
        # 所以放在 load 里调用 _prime_preset_voice_cache(new_model) 的目的，是：用户第一次点某个预置 Clone 时，尽量不用再等一长段冷启动
...
_fetch_preset_assets() # 下载预设的ref和transcripts
_load_preset_refs()    # 加载预设的ref和transcripts，并保存到全局变量_preset_refs中
...
async def transcribe_audio(audio: UploadFile = File(...)):
    """Transcribe reference audio into text using nano-parakeet."""
...
async def load_model(model_id: str = Form(...)):
    ...
    if model_id in _model_cache:
        ...
        _model_cache.move_to_end(model_id) # 把当前这个 model_id 在 _model_cache 里挪到“最末尾”
        return {"status": "already_loaded", "model": model_id}

    # 如果当前 model_id 不在 _model_cache 中，则开始加载模型。
    _loading = True # 设置 _loading 为 True，表示正在加载模型。

    def _do_load():
        global _active_model_name, _loading
        try:
            if len(_model_cache) >= _model_cache_max:
                # 从 OrderedDict 的最前面弹出一项。最近用过的模型会通过 move_to_end 放到末尾，所以队首就是**最久没被标记为“最近使用”**的那一个，相当于简单的 LRU（最近最少使用）淘汰。
                evicted, _ = _model_cache.popitem(last=False) # _model_cache 中腾出一个空位
            ...
            _active_model_name = model_id
            _prime_preset_voice_cache(new_model) # 在新模型加载完成后，用所有预置参考音色做一次“预热 / 填缓存”
            print("CUDA graphs captured — model ready.")
        finally:
            _loading = False

    # Hold the generation lock while loading to prevent OOM from concurrent inference
    # 在加载模型时，持有 _generation_lock，以防止并发推理时内存溢出。
    async with _generation_lock:
        await asyncio.to_thread(_do_load) # 在 _generation_lock 的保护下，异步执行 _do_load 函数。
    return {"status": "loaded", "model": model_id} # 返回加载成功信息。
