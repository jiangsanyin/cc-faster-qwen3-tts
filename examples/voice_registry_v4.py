"""
v4 音色注册表：JSON 文件 + 文件锁 + 原子替换写入。

供 voice_manager_router_v4.py（读写）与 openai_server_v4.py（热加载只读）使用。
"""
...
def load_config_v4(config_path: str) -> dict:
    """
    加载 v4 配置文件（JSON）。
